...
export default function RiwayatPendidikan() {
    return (
        ...
        <RowRiwayat jenjang="SD" sekolah="SDN Bojongloa III" tahun="2010" />
        <RowRiwayat jenjang="SMP" sekolah="MTSP Darul Hufadz" tahun="2016" />
        <RowRiwayat jenjang="SMK" sekolah="SMA Negeri Rancaekek" tahun="2019" />
